...
{
    class VS2012DarkAutoHideWindowControl : DockPanel.AutoHideWindowControl
    {
        private class VS2012DarkAutoHideWindowSplitterControl : SplitterBase
        {
            private static readonly SolidBrush _horizontalBrush = new SolidBrush(Color.FromArgb(0xFF, 0x33, 0x33, 0x33));
                    ...
                    case DockState.DockLeftAutoHide:
                        {
                            using (var path = new GraphicsPath())
                            {
                                ...
                                {
                                    CenterColor = Color.FromArgb(0xFF, 0x33, 0x33, 0x33),
